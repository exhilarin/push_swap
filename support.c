...
/*   Updated: 2025/04/13 02:28:47 by iguney           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
	...
	t_stack *stack_b)
{
	...
	if ((node_a->index <= stack_a->size / 2
			&& node_b->index <= stack_b->size / 2)
		|| (node_a->index > stack_a->size / 2
			&& node_b->index > stack_b->size / 2))
	{
	...
	t_stack *node_b)
{
	...
	i_a = get_index(node_a, *a);
	i_b = get_index(node_b, *b);
	size_a = stack_size(*a);
	size_b = stack_size(*b);
